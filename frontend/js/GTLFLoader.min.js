...
class GLTFLoader extends Loader {
  ...
  parse(e, t, s, n) {
    ...
    if ("string" == typeof e) r = e;
      ...
      } else r = LoaderUtils.decodeText(new Uint8Array(e));
    }
    ...
    l.setExtensions(a), l.setPlugins(i), l.parse(s, n);
  }
}
...
class GLTFLightsExtension {
  ...
  _loadLight(e) {
    ...
    switch (a.type) {
      case "directional":
        (i = new DirectionalLight(o)),
          i.target.position.set(0, 0, -1),
          i.add(i.target);
        break;
      case "point":
        (i = new PointLight(o)), (i.distance = l);
        break;
      case "spot":
        (i = new SpotLight(o)),
          (i.distance = l),
  ...
  extendMaterialParams(e, t) {
    ...
    if (
      ...
      void 0 !== a.clearcoatTexture &&
        r.push(s.assignTexture(t, "clearcoatMap", a.clearcoatTexture)),
      ...
      void 0 !== a.clearcoatNormalTexture &&
        (r.push(
          s.assignTexture(t, "clearcoatNormalMap", a.clearcoatNormalTexture)
        ),
  ...
  extendMaterialParams(e, t) {
    ...
    return (
      ...
      void 0 !== a.transmissionTexture &&
        r.push(s.assignTexture(t, "transmissionMap", a.transmissionTexture)),
      Promise.all(r)
    );
  }
}
...
class GLTFTextureWebPExtension {
  ...
  loadTexture(e) {
    ...
    return this.detectSupport().then(function (r) {
      if (r) return s.loadTextureImage(e, i, o);
  ...
  loadBufferView(e) {
    ...
    if (s.extensions && s.extensions[this.name]) {
      ...
      return Promise.all([n, r.ready]).then(function (t) {
        ...
        return (
          r.decodeGltfBuffer(new Uint8Array(o), a, i, l, e.mode, e.filter), o
        );
      });
    }
    return null;
...
class GLTFBinaryExtension {
  constructor(e) {
    ...
    for (; r < s; ) {
      ...
      if (((r += 4), s === BINARY_EXTENSION_CHUNK_TYPES.JSON)) {
        const s = new Uint8Array(e, 12 + r, t);
...
(GLTFCubicSplineInterpolant.prototype.beforeStart_ =
  ...
  (GLTFCubicSplineInterpolant.prototype.afterEnd_ =
    GLTFCubicSplineInterpolant.prototype.copySampleValue_),
  (GLTFCubicSplineInterpolant.prototype.interpolate_ = function (e, t, s, n) {
...
function createPrimitiveKey(e) {
  ...
  return (
    (s = t
      ...
      : e.indices + ":" + createAttributesKey(e.attributes) + ":" + e.mode),
    s
  );
}
...
class GLTFParser {
    ...
    this.cache.removeAll(),
      ...
      Promise.all(
        ...
        .then(function (t) {
          ...
          addUnknownExtensionsToUserData(r, a, n),
            assignExtrasToUserData(a, n),
            Promise.all(
  ...
  loadBuffer(e) {
    ...
    return new Promise(function (e, r) {
      s.load(resolveURL(t.uri, n.path), e, void 0, function () {
        r(
  ...
  loadAccessor(e) {
    ...
    return (
      ...
      Promise.all(r).then(function (e) {
        const r = e[0],
          a = WEBGL_TYPE_SIZES[n.type],
          i = WEBGL_COMPONENT_TYPES[n.componentType],
        ...
        if (u && u !== l) {
          ...
          let l = t.cache.get(s);
          l ||
            ((h = new i(r, e * u, (n.count * u) / o)),
            (l = new InterleavedBuffer(h, u / o)),
            t.cache.add(s, l)),
            (d = new InterleavedBufferAttribute(l, a, (c % u) / o, p));
        } else (h = null === r ? new i(n.count * a) : new i(r, c, n.count * a)), (d = new BufferAttribute(h, a, p));
        if (void 0 !== n.sparse) {
          const t = WEBGL_TYPE_SIZES.SCALAR,
            s = WEBGL_COMPONENT_TYPES[n.sparse.indices.componentType],
            o = n.sparse.indices.byteOffset || 0,
            l = n.sparse.values.byteOffset || 0,
            c = new s(e[1], o, n.sparse.count * t),
            u = new i(e[2], l, n.sparse.count * a);
          null !== r &&
            (d = new BufferAttribute(
              d.array.slice(),
              d.itemSize,
              d.normalized
            ));
          for (let e = 0, t = c.length; e < t; e++) {
            ...
            if (
              (d.setX(t, u[e * a]),
              a >= 2 && d.setY(t, u[e * a + 1]),
              a >= 3 && d.setZ(t, u[e * a + 2]),
              a >= 4 && d.setW(t, u[e * a + 3]),
              a >= 5)
            )
              throw new Error(
  ...
  loadTextureImage(e, t, s) {
    const n = this,
      ...
      a = this.options,
      i = r.textures[e],
      o = (t.uri || t.bufferView) + ":" + i.sampler;
    ...
    if (
      (("image/jpeg" === t.mimeType || h) && (p = !1), void 0 !== t.bufferView)
    )
      c = n.getDependency("bufferView", t.bufferView).then(function (e) {
        ...
        return (c = l.createObjectURL(s)), c;
      });
      ...
      .then(function (e) {
        return new Promise(function (t, n) {
          ...
          !0 === s.isImageBitmapLoader &&
            ...
            s.load(resolveURL(e, a.path), r, void 0, n);
        });
      })
      .then(function (t) {
        !0 === u && l.revokeObjectURL(c),
          ...
          p || (t.format = RGBFormat);
        const s = (r.samplers || {})[i.sampler] || {};
        return (
          (t.magFilter = WEBGL_FILTERS[s.magFilter] || LinearFilter),
          (t.minFilter =
            WEBGL_FILTERS[s.minFilter] || LinearMipmapLinearFilter),
          (t.wrapS = WEBGL_WRAPPINGS[s.wrapS] || RepeatWrapping),
          (t.wrapT = WEBGL_WRAPPINGS[s.wrapT] || RepeatWrapping),
  ...
  assignTexture(e, t, s) {
    ...
    return this.getDependency("texture", s.index).then(function (r) {
      if (
        ...
        n.extensions[EXTENSIONS.KHR_TEXTURE_TRANSFORM])
      ) {
        const e =
          void 0 !== s.extensions
            ? s.extensions[EXTENSIONS.KHR_TEXTURE_TRANSFORM]
            : void 0;
        if (e) {
          const t = n.associations.get(r);
          (r = n.extensions[EXTENSIONS.KHR_TEXTURE_TRANSFORM].extendTexture(
            r,
            e
          )),
  ...
  assignFinalMaterial(e) {
    ...
    const n = void 0 !== t.attributes.tangent,
      ...
      o = i && void 0 !== t.morphAttributes.normal;
    if (e.isPoints) {
      const e = "PointsMaterial:" + s.uuid;
      let t = this.cache.get(e);
      t ||
        ((t = new PointsMaterial()),
        Material.prototype.copy.call(t, s),
  ...
  loadMaterial(e) {
    ...
    if (o[EXTENSIONS.KHR_MATERIALS_PBR_SPECULAR_GLOSSINESS]) {
      ...
      (a = e.getMaterialType()), l.push(e.extendParams(i, r, t));
      ...
      void 0 !== s.baseColorTexture &&
        l.push(t.assignTexture(i, "map", s.baseColorTexture)),
        (i.metalness = void 0 !== s.metallicFactor ? s.metallicFactor : 1),
        (i.roughness = void 0 !== s.roughnessFactor ? s.roughnessFactor : 1),
        void 0 !== s.metallicRoughnessTexture &&
          (l.push(
            t.assignTexture(i, "metalnessMap", s.metallicRoughnessTexture)
          ),
          l.push(
            t.assignTexture(i, "roughnessMap", s.metallicRoughnessTexture)
          )),
    ...
    return (
      c === ALPHA_MODES.BLEND
        ...
        : ((i.transparent = !1),
          c === ALPHA_MODES.MASK &&
            (i.alphaTest = void 0 !== r.alphaCutoff ? r.alphaCutoff : 0.5)),
      void 0 !== r.normalTexture &&
        a !== MeshBasicMaterial &&
        (l.push(t.assignTexture(i, "normalMap", r.normalTexture)),
        (i.normalScale = new Vector2(1, -1)),
        void 0 !== r.normalTexture.scale &&
          i.normalScale.set(r.normalTexture.scale, -r.normalTexture.scale)),
      void 0 !== r.occlusionTexture &&
        a !== MeshBasicMaterial &&
        (l.push(t.assignTexture(i, "aoMap", r.occlusionTexture)),
        void 0 !== r.occlusionTexture.strength &&
          (i.aoMapIntensity = r.occlusionTexture.strength)),
      void 0 !== r.emissiveFactor &&
        a !== MeshBasicMaterial &&
        (i.emissive = new Color().fromArray(r.emissiveFactor)),
      void 0 !== r.emissiveTexture &&
        a !== MeshBasicMaterial &&
        l.push(t.assignTexture(i, "emissiveMap", r.emissiveTexture)),
      Promise.all(l).then(function () {
        let s;
        return (
          (s =
            a === GLTFMeshStandardSGMaterial
              ? n[
                  EXTENSIONS.KHR_MATERIALS_PBR_SPECULAR_GLOSSINESS
                ].createMaterial(i)
              : new a(i)),
          r.name && (s.name = r.name),
          s.map && (s.map.encoding = sRGBEncoding),
          s.emissiveMap && (s.emissiveMap.encoding = sRGBEncoding),
          assignExtrasToUserData(s, r),
          t.associations.set(s, { type: "materials", index: e }),
          r.extensions && addUnknownExtensionsToUserData(n, s, r),
          s
        );
      })
    );
  ...
  loadGeometries(e) {
    ...
    function r(e) {
      return s[EXTENSIONS.KHR_DRACO_MESH_COMPRESSION]
        .decodePrimitive(e, t)
        .then(function (s) {
    ...
    for (let s = 0, i = e.length; s < i; s++) {
      const i = e[s],
        o = createPrimitiveKey(i),
        l = n[o];
      if (l) a.push(l.promise);
      else {
        let e;
        (e =
          i.extensions && i.extensions[EXTENSIONS.KHR_DRACO_MESH_COMPRESSION]
            ? r(i)
            : addPrimitiveAttributes(new BufferGeometry(), i, t)),
      ...
      Promise.all(i).then(function (s) {
        ...
        for (let s = 0, c = o.length; s < c; s++) {
          ...
          if (
            ...
            (p =
              !0 === r.isSkinnedMesh ? new SkinnedMesh(c, h) : new Mesh(c, h)),
              !0 !== p.isSkinnedMesh ||
                p.geometry.attributes.skinWeight.normalized ||
                p.normalizeSkinWeights(),
              u.mode === WEBGL_CONSTANTS.TRIANGLE_STRIP
                ? (p.geometry = toTrianglesDrawMode(
                    p.geometry,
                    TriangleStripDrawMode
                  ))
                : u.mode === WEBGL_CONSTANTS.TRIANGLE_FAN &&
          ...
          else if (u.mode === WEBGL_CONSTANTS.LINES) p = new LineSegments(c, h);
          else if (u.mode === WEBGL_CONSTANTS.LINE_STRIP) p = new Line(c, h);
          else if (u.mode === WEBGL_CONSTANTS.LINE_LOOP) p = new LineLoop(c, h);
          else {
          ...
          Object.keys(p.geometry.morphAttributes).length > 0 &&
            updateMorphTargets(p, r),
            (p.name = t.createUniqueName(r.name || "mesh_" + e)),
            assignExtrasToUserData(p, r),
            u.extensions && addUnknownExtensionsToUserData(n, p, u),
  ...
  loadAnimation(e) {
    ...
    return Promise.all([
      ...
      for (let e = 0, t = n.length; e < t; e++) {
        ...
        let h;
        switch (
          (t.updateMatrix(), (t.matrixAutoUpdate = !0), PATH_PROPERTIES[p.path])
        ) {
          case PATH_PROPERTIES.weights:
            h = NumberKeyframeTrack;
            break;
          case PATH_PROPERTIES.rotation:
            h = QuaternionKeyframeTrack;
            break;
          default:
            h = VectorKeyframeTrack;
        }
        const d = t.name ? t.name : t.uuid,
          m =
            void 0 !== u.interpolation
              ...
              : InterpolateLinear,
          f = [];
        PATH_PROPERTIES[p.path] === PATH_PROPERTIES.weights
        ...
        for (let e = 0, t = f.length; e < t; e++) {
          const t = new h(f[e] + "." + PATH_PROPERTIES[p.path], s.array, T, m);
  ...
  loadNode(e) {
    ...
    return (function () {
      ...
      if (
        (r.name && ((i.userData.name = r.name), (i.name = a)),
        assignExtrasToUserData(i, r),
        r.extensions && addUnknownExtensionsToUserData(s, i, r),
        void 0 !== r.matrix)
      ) {
        const e = new Matrix4();
      ...
      return n.associations.set(i, { type: "nodes", index: e }), i;
    });
  }
  loadScene(e) {
    const t = this.json,
    ...
    n.name && (a.name = r.createUniqueName(n.name)),
      assignExtrasToUserData(a, n),
      n.extensions && addUnknownExtensionsToUserData(s, a, n);
    const i = n.nodes || [],
      o = [];
    for (let e = 0, s = i.length; e < s; e++)
      o.push(buildNodeHierachy(i[e], a, t, r));
    return Promise.all(o).then(function () {
      return a;
    });
  }
}
function buildNodeHierachy(e, t, s, n) {
  const r = s.nodes[e];
  return n
      ...
      return n
        ...
        .then(function (e) {
          ...
          for (let e = 0, r = t.joints.length; e < r; e++)
            s.push(n.getDependency("node", t.joints[e]));
    ...
    .then(function (e) {
      ...
      if (r.children) {
        ...
        for (let r = 0, i = t.length; r < i; r++) {
          const i = t[r];
          a.push(buildNodeHierachy(i, e, s, n));
        }
      }
      return Promise.all(a);
    });
...
function computeBounds(e, t, s) {
  ...
  if (void 0 === n.POSITION) return;
  {
    ...
    if (
      (r.set(new Vector3(t[0], t[1], t[2]), new Vector3(a[0], a[1], a[2])),
      e.normalized)
    ) {
      const t = getNormalizedComponentScale(
        WEBGL_COMPONENT_TYPES[e.componentType]
      );
    ...
    for (let n = 0, r = a.length; n < r; n++) {
      ...
      if (void 0 !== r.POSITION) {
        ...
        if (void 0 !== a && void 0 !== i) {
          if (
            (t.setX(Math.max(Math.abs(a[0]), Math.abs(i[0]))),
            t.setY(Math.max(Math.abs(a[1]), Math.abs(i[1]))),
            t.setZ(Math.max(Math.abs(a[2]), Math.abs(i[2]))),
            n.normalized)
          ) {
            const e = getNormalizedComponentScale(
              WEBGL_COMPONENT_TYPES[n.componentType]
            );
            t.multiplyScalar(e);
          }
          e.max(t);
...
function addPrimitiveAttributes(e, t, s) {
  ...
  for (const t in n) {
    ...
    s in e.attributes || r.push(a(n[t], s));
  }
