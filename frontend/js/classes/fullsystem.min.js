class Rogue_Form extends HTMLElement {
  constructor() {
    super();
    this.tle;
  }
  init(i) {
    console.log("CONTACT");
    this.tle = ScrollTrigger.create({
      trigger: ".form-container2",
      scroller: "#page",
      start: "top center",
      end: `bottom bottom`,
      ...
      onEnter: function (self) {
        gsap.to(".page-inner", {
          backgroundColor: "rgba(255, 196, 0)",
          duration: 0.5,
        });
        gsap.fromTo(
          ".form-title,.form-text-cont p",
  ...
  connectedCallback() {
    let it = `<h3 class='form-title'>Kontakt</h3>
        <div class="form-text-cont">
          
          <p>Wenn du neugierig bist, mehr über das zu erfahren, was du gesehen hast, lade ich dich ein, mich zu kontaktieren oder mir in den sozialen Medien zu folgen</p>
            <div class="social-container">
              <a href="mailto:actuallyme@jolinesserver.com" target="_blank"><img class="social-icon" src="./assets/icons/mail.svg" alt="icon prev"></a>
              <a href='https://www.instagram.com/johnneedsaladder/' target="_blank"><img class="social-icon" src="./assets/icons/ig.svg" alt="icon prev"></a>
              <a href='https://www.linkedin.com/in/joline-elizabeth-o-brien-1a72b3367/' target="_blank"><img class="social-icon" src="./assets/icons/linkedin.svg" alt="icon prev"></a>

            </div>
          </div>
        <form id="contact-form"><input id="website" name="website" type="text" tabindex="-1" autocomplete="off" aria-hidden="true" style="position:absolute;left:-9999px;top:-9999px;width:1px;height:1px;opacity:0" />      
            ...
            <textarea id='message' name="message" class="feedback-input" placeholder="Wie kann ich Ihnen helfen?"></textarea>
            <input type="submit" value="SENDEN"/>
        </form>

        `;
    let en = `<h3 class='form-title'>Contact</h3>
        <div class="form-text-cont">

          <p>If you're curious to learn more about what you've seen, I invite you to reach out to me or follow me on social media</p>
            <div class="social-container">
              <a href="mailto:actuallyme@jolinesserver.com" target="_blank"><img class="social-icon" src="./assets/icons/mail.svg" alt="icon prev"></a>
              <a href='https://www.instagram.com/johnneedsaladder/' target="_blank"><img class="social-icon" src="./assets/icons/ig.svg" alt="icon prev"></a>
              <a href='https://www.linkedin.com/in/joline-elizabeth-o-brien-1a72b3367/' target="_blank"><img class="social-icon" src="./assets/icons/linkedin.svg" alt="icon prev"></a>
        ...
        <form id="contact-form"><input id="website" name="website" type="text" tabindex="-1" autocomplete="off" aria-hidden="true" style="position:absolute;left:-9999px;top:-9999px;width:1px;height:1px;opacity:0" />      
            <input id='name' name="name" type="text" class="feedback-input" placeholder="Name" />   
            <input id='email' name="email" type="text" class="feedback-input" placeholder="Email" />
            <textarea id='message' name="message" class="feedback-input" placeholder="How can I help you?"></textarea>
    ...
    window.addEventListener("navsystem", (e) => {
      if (e.detail.prop == "lang" && e.detail.arg == "it") {
        this.innerHTML = it;
        gsap.fromTo(
          ".form-title,.form-text-cont p",
          { color: "#fff" },
      ...
      } else if (e.detail.prop == "lang" && e.detail.arg == "en") {
        this.innerHTML = en;
        gsap.fromTo(
          ".form-title,.form-text-cont p",
          { color: "#fff" },
...
customElements.define("custom-form", Rogue_Form);
!(function (e, t) {
...
class myGalleries extends HTMLElement {
  constructor() {
    super();
    this.gallData = null;
  ...
  #events() {
    $("#nextG").click(() => {
      var p = this.index;
      var navindex = p.indexOf(this.currentData.id);
      var next = (navindex + 1 + p.length) % p.length;
      this.#pagination(p[next]);
    });
    $("#prevG").click(() => {
      var p = this.index;
      var navindex = p.indexOf(this.currentData.id);
      var prev = (navindex - 1 + p.length) % p.length;
      this.#pagination(p[prev]);
    });
  }
  #deploy() {
    $.each(this.currentData.galleries, (key, elem) => {
      let gname = elem.gname;
      let gId = "gid-" + elem.gid;
      let galleryStructure;
      if (window.innerWidth > 1000) {
        galleryStructure = `
                <div class="gallery-info" >

                    <div class='gallery-cover' style="background-image:url( ${elem.gcover})"></div>
                     
                    <h2 class='GalleryName'>${gname}</h2>
                </div>
                
                <p class='gal-description'>${elem.descr}</p>
                <div class="img-columns" id="${gId}">
      ...
      $(".allGalleries .gmargins").append(galleryStructure);
      let index = 1;
      let timer = 1;
      $.each(elem.images, (num, imm) => {
        let im = `
                    <a class='js-smartPhoto' data-gallery="${gId}" data-fslightbox='gallery-${gId}' href="${imm.src}"> 
                        <div class="single-image" id='${gId}-${num}'>
                            <div class="img-cont">
                                <img alt="gallery img" class="gallery-img"  src="${imm.th}"/>
                            </div>
                        </div>
                    </a>
                `;
        $("#" + gId)
          .find(".column:nth-child(" + index + ")")
          .append(im);
        if (window.innerWidth > 1000) {
          if (index == 4) {
            index = 1;
        ...
        setTimeout(() => {
          $("#" + gId + "-" + num).addClass("img-loaded");
        }, timer * 40);
        timer = timer + 3;
      });
      let lb = new SimpleLightbox("#gid-" + elem.gid + " .column a");
      console.log("GALLERY PRONTA");
      if (window.innerWidth > 1000) {
        lenis.resize();
        var starter = document.querySelector(".page-inner");
        lenis.scrollTo(starter, { immediate: !0 });
      } else {
        $("#page").scrollTop(0);
      }
      setTimeout(() => {
  ...
  #pagination(data) {
    $(".single-g-selector").removeClass("g-selected");
    this.currentData = this.gallData[data];
    this.catName = this.currentData.category;
    $(".activeCategoryName").html(this.catName);
    $(".allGalleries .gmargins").html("");
    let catDesc = `<p class='cat-description'>${this.currentData.description}</p>`;
    $(".allGalleries .gmargins").append(catDesc);
    $("#gsgs-" + data).addClass("g-selected");
    this.#deploy();
  }
  get getStatus() {
  ...
  get scrollerOn() {
    console.log("gscroll");
    $(".allGalleries").addClass("scrollOn");
  }
  get scrollerOff() {
    $(".allGalleries").removeClass("scrollOn");
  }
  set loader(data) {
    this.gallData = data;
    $.each(this.gallData, (key, elem) => {
      this.index.push(elem.id);
      let g = `

                <div class="single-g-selector" id='gsgs-${elem.id}' data-linker='${elem.id}'>
                    <div class='single-g-img' style="background-image:url( ${elem.cover})">
                    </div>
                    <p>${elem.category}</p>
                </div>
                `;
      $(".gallerySelectorContainer").append(g);
    });
    if (window.innerWidth >= 1000) {
    }
    $(".single-g-selector").click(function () {
      let set = $(this).data("linker");
      $(this).addClass("g-selected");
      const div = document.querySelector(".allGalleries");
      div.scroll({ top: 0, behavior: "smooth" });
      $("my-galleries")[0].init = set;
    });
  }
  set init(data) {
    if (!this.isActive) {
  ...
  connectedCallback() {
    let inner = `
            ...
            <div id="gallery-container">
                <div class='activeCategoryControls' style='display:none;' >
                    <div class='gmargins'>
                        <div class='gallerySelector' id='gallerySelector'>
                            <div class='gallerySelectorContainer'>
                            
                            </div>
                        </div>


                        <div id="prevG" class='gnav'>
                            <img alt='prev icon' id="gprevimg" src="assets/icons/left.svg" />
                        </div>
                        <div id="nextG" class='gnav'>
                            <img alt='next icon' id="gnextimg" src="assets/icons/right.svg" />
                        </div>

                    </div>
                </div>
                <div class='activeCategoryName'></div>
                
                <div class='allGalleries'>
                    <div class='gmargins'></div>
                </div>
...
customElements.define("my-galleries", myGalleries);
function resetColor() {
  gsap.to(".page-inner", { backgroundColor: "rgb(12 12 12)", duration: 0.5 });
  gsap.fromTo(
    ".form-title,.form-text-cont p",
    { color: "#000" },
    { color: "#fff" }
...
function heroImage() {
  let parallax = gsap.timeline().to(".bkg-img", {
    scale: "1.5",
    opacity: 0,
    scrollTrigger: {
      scroller: "#page",
  ...
  let tl0 = gsap.timeline({ paused: !0 });
  tl0.to(".bkg-img", { top: "0%", ease: "power4.out", duration: 0.5 });
  tl0.to(
    ".hero-title",
    { width: "100%", height: "50%", ease: "power4.out", duration: 1 },
    "-=0.2"
  );
  tl0.to(
    ".page-title",
    { left: "0%", ease: "power4.out", duration: 0.5 },
    "-=0.2"
  );
  tl0.to(
    "#page .hero p",
    { opacity: 1, ease: "power4.out", duration: 0.2 },
    "-=0.2"
  );
  tl0.play();
}
function pageTextAanimation() {
  if (window.innerWidth > 1000) {
    let trigger = gsap.utils.toArray(".bods");
    ...
    trigger.forEach((element) => {
      ...
      tl.fromTo(
        q(".anim"),
        { y: 300, opacity: 0 },
        { ease: "power4.out", opacity: 1, duration: 1, y: 0, stagger: 0.2 }
      );
    });
  }
}
function verticalCards() {
  ...
  const titles = gsap.utils.toArray(".v-card-title h2");
  titles.forEach((title) => {
    var newText = "";
    for (let i = 0; i < title.innerText.length; i++) {
      newText += "<div class='v-char'>";
      if (title.innerText[i] == " ") {
        newText += "<span>&nbsp;</span>";
      } else {
        newText += "<span class='vc'>" + title.innerText[i] + "</span>";
      }
      newText += "</div>";
    }
    title.innerHTML = newText;
  });
  const cardImgWrapper = introCard.querySelector(".v-card-img");
  const cardImg = introCard.querySelector(".v-card-img img");
  ...
  const titleChars = introCard.querySelectorAll(".v-char .vc");
  const description = introCard.querySelector(".v-card-desc");
  ScrollTrigger.create({
    ...
    onUpdate: (self) => {
      ...
      if (progress >= 1 && !introCard.contentRevealed) {
        introCard.contentRevealed = !0;
        animateContentIn(titleChars, description);
      }
      if (progress < 1 && introCard.contentRevealed) {
        introCard.contentRevealed = !1;
  ...
  cards.forEach((card, index) => {
    if (index < cards.length - 1) {
      const cardWrapper = card.querySelector(".v-card-wrapper");
      ScrollTrigger.create({
  ...
  cards.forEach((card, index) => {
    if (index > 0) {
      const cardImg = card.querySelector(".v-card-img img");
      const imgContainer = card.querySelector(".v-card-img");
      ScrollTrigger.create({
        trigger: card,
        start: "top bottom",
        end: "top top",
  ...
  cards.forEach((card, index) => {
    if (index === 0) return;
    const cardDescription = card.querySelector(".v-card-desc");
    const cardTitleChars = card.querySelectorAll(".v-char .vc");
    ScrollTrigger.create({
      trigger: card,
      start: "top center",
      scroller: "#page",
